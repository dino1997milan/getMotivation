...
public final class HeaderLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView mailUtenteLoggato;

  private HeaderLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView mailUtenteLoggato) {
  ...
  public static HeaderLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.mailUtenteLoggato;
      TextView mailUtenteLoggato = ViewBindings.findChildViewById(rootView, id);
      if (mailUtenteLoggato == null) {
        break missingId;
      }

      return new HeaderLayoutBinding((ConstraintLayout) rootView, mailUtenteLoggato);
    }
